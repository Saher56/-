...
+((+a5.value + +a6.value)/2) * (b5.value)+
+((+a6.value + +a7.value)/2) * (b6.value)+
+((+(+a6.value + +a7.value)/2) + +(+a7.value - +a6.value)) * (b7.value)) / (+b1.value + +b2.value + +b3.value + +b4.value + +b5.value + +b6.value + +b7.value) }</h1>
</div>
<button onclick= "prrint()">اطبع الناتج</button>
`
